...
function UploadCvPage() {
  ...
  const handleSubmitForm = async (e) => {
    ...
    if (!verifyUploadCV(form.file.name))
      return Swal.fire(
        'Oops...',
    ...
    if (form.title && form.file) {
      ...
      if (fileUrl) {
        ...
        if (res.success) {
          ...
          notify('Upload CV successed', history.push('/profile'))
        }
      }
    }
  };
    ...
    <MainLayout>
      ...
      >
        <Form.Group controlId="formBasicEmail">
          <Form.Label>
            <strong>Curriculum Vitae title</strong>
          </Form.Label>
          <Form.Control
            type="text"
        ...
        <Form.Group>
          <Form.Label>
            <strong>Upload your CV (.doc,.docx,.pdf)</strong>
          </Form.Label>
          <Form.File
            id="custom-file"
