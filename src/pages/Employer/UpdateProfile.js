...
function UpdateProfile() {
    ...
    const handleUploadImage = (e) => {
        ...
        if(!validateImageFile(file.type)) return Swal.fire('Oops...', 'Must upload image file only!', 'error')
    ...
    const handleUploadLogo = (e) => {
        ...
        if(!validateImageFile(newLogo.type)) return Swal.fire('Oops...', 'Must upload image file only!', 'error')
    ...
    return(
        <MainLayout>
            <Form className="p-5 mt-5" onSubmit={handleSubmitForm}>
                ...
                <Form.Group>
                    <Form.Label><strong>Company Logo</strong></Form.Label>
                    <Row className="mb-2">
                        <Col xs={2}>
                ...
                <Form.Group>    
                    <Form.Label><strong>Current Images</strong></Form.Label>
                    <Row>
                        {renderCurrentImgs(currenImgs)}
                    </Row>
                </Form.Group>
                <Form.Group>
                    <Form.Label><strong>Upload Images</strong></Form.Label>
                    <Row className="mb-2">
                        {renderImages(images)}
                    </Row>
                    <div className={classes.root}>
